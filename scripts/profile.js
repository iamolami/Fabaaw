...
toggleMore.addEventListener('click', () => {
  moreBox.classList.toggle('container___784hyr78r');
})
...
const closeMore = document.querySelectorAll('container__7gt278j');

closeMore.forEach(more => {
  more.addEventListener('click', () => {
    toggleMore.classList.remove('container___784hyr78r')
  })
});